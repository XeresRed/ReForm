...
export var useForm = function (InitialState, config) {
    ...
    var ValidateInput = function (id, value) {
        ...
        var field = values[id];
        var flagError = [];
        for (var _i = 0, _g = field.validators; _i < _g.length; _i++) {
            var validator = _g[_i];
            if (validator.extras) {
            ...
            if (validation[validator.type]) {
                ...
                setErrors(__assign(__assign({}, errors), (_b = {}, _b[id] = __assign(__assign({}, errors[id]), validation), _b)));
            }
            else {
                setErrors(__assign(__assign({}, errors), (_c = {}, _c[id] = __assign(__assign({}, errors[id]), validation), _c)));
            }
        }
        setValues(__assign(__assign({}, values), (_d = {}, _d[id] = {
            validators: values[id].validators,
            value: value,
            class: flagError.length === 0 ? (_e = config.customClass) === null || _e === void 0 ? void 0 : _e.success : (_f = config.customClass) === null || _f === void 0 ? void 0 : _f.error
        }, _d)));
    };
